...
return [
    ...
    new Token(Token::NAME, 'set', 3, 4),
    new Token(Token::NAME, 'foo', 3, 8),
    new Token(Token::OPERATOR, '=', 3, 12),
    new Token(Token::STRING, 'BAR', 3, 14),
    new Token(Token::BLOCK_END, '%}', 3, 20),
    new Token(Token::TEXT, "\n", 3, 22),
    ...
    new Token(Token::OPERATOR, '=', 5, 10),
    new Token(Token::NUMBER, '42', 5, 12),
    ...
    new Token(Token::NAME, 'set', 10, 4),
    new Token(Token::NAME, 'foo', 10, 8),
    new Token(Token::OPERATOR, '=', 10, 12),
    new Token(Token::STRING, 'bar', 10, 14),
    new Token(Token::BLOCK_END, '%}', 10, 20),
    new Token(Token::TEXT, "\n\n", 10, 22),
